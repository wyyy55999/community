...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal" enctype="multipart/form-data">
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="publisher" value="<?php echo ((isset($info["publisher"]) && ($info["publisher"] !== ""))?($info["publisher"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="status">
                    <option value="0" <?php if(($info["status"]) == "0"): ?>selected<?php endif; ?>>未租/售</option>
                    <option value="1" <?php if(($info["status"]) == "1"): ?>selected<?php endif; ?>>已租/售</option>
                </select>
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <input id="upload_button" type="file" multiple="multiple" value="<?php echo ((isset($info["image_path"]) && ($info["image_path"] !== ""))?($info["image_path"]):''); ?>" name="image"/>
                <img src="<?php echo ((isset($info["image_path"]) && ($info["image_path"] !== ""))?($info["image_path"]):''); ?>" id="uploadify_image" width="300" />
                <input type="hidden" name="image_path" value="<?php echo ((isset($info["image_path"]) && ($info["image_path"] !== ""))?($info["image_path"]):''); ?>" id="image_path_hidden">
                <script type="text/javascript">
                    $('#upload_button').uploadify({
                        'swf'      : '/Public/static/uploadify/uploadify.swf',
                        'uploader' : "<?php echo U('rental/uploadify');?>",//这个就是处理上传文件的地址
                        'buttonText' : '上传照片',
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <textarea name="description" id="info" style="width:1024px;height:500px;"><?php echo ((isset($info["description"]) && ($info["description"] !== ""))?($info["description"]):''); ?></textarea>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">截止日期</label>
            <div class="controls">
                <input type="datetime-local" class="text input-large" name="end_at" value="<?php echo ((isset($info["end_at"]) && ($info["end_at"] !== ""))?($info["end_at"]):''); ?>">
            </div>
        </div>
		<div class="form-item">
