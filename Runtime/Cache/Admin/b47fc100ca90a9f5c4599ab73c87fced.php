...
<body>
	...
	<div class="cf">
		...
		<button class="btn list_sort" url="<?php echo U('sort');?>">排序</button>
	</div>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rental): $mod = ($i % 2 );++$i;?><tr>
						<td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo ($rental['id']); ?>"> </td>
						<td><?php echo ($rental["id"]); ?></td>
						<td><?php echo ($rental["publisher"]); ?></td>
						<td><?php echo ($rental["tel"]); ?></td>
