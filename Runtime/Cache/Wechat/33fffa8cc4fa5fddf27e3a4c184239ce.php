...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布者:<?php echo ($detail["publisher"]); ?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo (time_format($detail["create_at"])); ?></div>
        <div class="noticeDetailInfo">联系电话：<?php echo ($detail["tel"]); ?></div>
        <h4 class="text-danger">价格:<?php echo ($detail["price"]); echo ($detail["price_suffix"]); ?></h4>
