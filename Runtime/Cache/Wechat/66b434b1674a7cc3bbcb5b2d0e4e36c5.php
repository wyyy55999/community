...
<div class="main">
    ...
    <div class="container-fluid">
        <form class="login-form" action="<?php echo U('Wechat/register');?>" method="post">
            ...
            <div class="controls" style="margin-bottom: 20px;">
                <img class="verifyimg reloadverify" alt="点击切换" onclick="this.src='/wechat.php?s=/Wechat/verify.html'" src="<?php echo U('Wechat/verify');?>" style="cursor:pointer;height: 40px;">
            </div>
            <p>
                <button class="btn btn-lg btn-primary btn-block" type="submit">注册</button>
            </p>
        </form>
        <p class="text-right"><a href="<?php echo U('Wechat/login');?>">已有账号，直接登录</a></p>
    </div>
